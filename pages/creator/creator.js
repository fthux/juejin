Page({
  data: {
    ...
    entries: [
      { name: '数据中心', description: '查看内容表现与趋势', icon: '/assets/app/creator/ic_creator_data_center.webp', url: '' },
      { name: '关注数据', description: '关注者变化与画像', icon: '/assets/app/creator/ic_creator_follow_data_center.webp', url: '' },
      { name: '创作活动', description: '参与社区创作活动', icon: '/assets/app/creator/ic_creator_activity.webp', url: '' },
