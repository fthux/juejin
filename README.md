...
拉取当前项目源码，使用微信开发者工具导入并预览，也可以通过真机运行开发版，体验原生微信小程序版本。

### 2. H5 版本（推荐）

访问由小程序转换生成的 [H5 版本](https://juejin.fthux.com/#live)，无需安装或配置开发环境，可直接在浏览器中体验。

### 3. 小程序录屏

不方便运行项目时，可以 [观看小程序录屏](https://juejin.fthux.com/#recording)，快速了解主要页面和交互效果。
