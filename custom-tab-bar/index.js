...
const tabs = [
  ...
  { pagePath: '/pages/find/find', text: '发现', icon: '/assets/app/tabs/tab_find_normal.png', selectedIcon: '/assets/app/tabs/tab_find_dark.png', darkIcon: '/assets/app/tabs/tab_find_normal_dark.png', darkSelectedIcon: '/assets/app/tabs/tab_find_dark.png' },
